...
<p align="center">
  ...
  <h3 align="center">Hybrid Analysis</h3>

  <p align="center">
    This project is connected to my other repo "random-api"
  </p>
</p>
...
1. Clone the repo
   ```sh
   git clone https://github.com/jmateocarbon/hybrid-analysis-api.git
   ```
...
Just run the script HybridAnalysis.py

Then Input necessary data

I.E
python HybridAnalysis.py "url"
